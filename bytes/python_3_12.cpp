...
BEGIN_CACHES_MAP(3, 12)
    MAP_CACHES_OP(BINARY_SUBSCR, 1)
    MAP_CACHES_OP(STORE_SUBSCR, 1)
    MAP_CACHES_OP(UNPACK_SEQUENCE_A, 1)
    MAP_CACHES_OP(FOR_ITER_A, 1)
    MAP_CACHES_OP(STORE_ATTR_A, 4)
    MAP_CACHES_OP(LOAD_ATTR_A, 9)
    MAP_CACHES_OP(COMPARE_OP_A, 1)
    MAP_CACHES_OP(LOAD_GLOBAL_A, 4)
    MAP_CACHES_OP(BINARY_OP_A, 1)
    MAP_CACHES_OP(SEND_A, 1)
    MAP_CACHES_OP(LOAD_SUPER_ATTR_A, 1)
    MAP_CACHES_OP(CALL_A, 3)
END_CACHES_MAP()